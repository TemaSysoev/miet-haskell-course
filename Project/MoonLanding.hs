...
-- В школе на первых уроках по физике я написал простейший пошаговый симулятор
...
-- и он слишком на большой скорости врезается в поверхность – проиграл, мягкая посадка –
-- победа!
--
-- Настройки
gravity :: Double
